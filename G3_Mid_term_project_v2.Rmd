...
```{r, results='asis'}
jpeg(file="sample per sex and state.jpeg")
...
jpeg(file="levels_of_education_of_the_sample.jpeg")
...
```{r, results='asis'}
jpeg(file= "avg_replacement_ratio.jpeg")
...
```{r, results='asis'}
library(ggbeeswarm)
jpeg(file="household_income_distribution.jpeg")
