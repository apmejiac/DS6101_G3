...
#has this error Error in `is.data.frame()`:
#! Join columns must be present in data.
#✖ Problem with `week`.
#Backtrace:
# 1. dplyr::left_join(df_panel2, r, by = c(Week2 = "week", "State"))
# 7. dplyr:::left_join.data.frame(df_panel2, r, by = c(Week2 = "week", "State"))
