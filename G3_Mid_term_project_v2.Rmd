...
Evaluating the cross sectional panel, we were able to see that the panel is balanced and it has more than 3 million observations. The sample size was reduced when we eliminated the persons that had an income higher than $150,000 and that did not lose employment, given that they would not be the most vulnerable group affected by the pandemic.This reduced the sample size to close to 300 thousand observations. As it was previously mentioned, most of the people in our sample were not interviewed more than three times. Given that the characteristic of cross- sectional data solves normality, rather than focusing in doing normality tests of the data, we focused in understanding it further and the linkages that they seem to be present between variables. Taking a careful look at our data set is relevant so we can better understood the best approach for a regression analysis. The following section highlights some of the key plots 
