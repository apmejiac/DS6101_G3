...
e1 + geom_bar(position = "dodge",
             mapping = aes(y = ..prop.., group = Edu))+ 
              labs(title="Levels of Education in the Sample",
...
#df_panel2$Other_race[df_panel2$Other_race==1]<- 'White' 
#df_panel2$Other_race[df_panel2$Other_race==2]<- 'Black'
#df_panel2$Other_race[df_panel2$Other_race==3]<- 'Asian' 
#df_panel2$Other_race[df_panel2$Other_race==4]<- 'Any other Race, or race in combination'
