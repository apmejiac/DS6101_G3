...
df_panel2$Sex[df_panel2$Sex==2]<- 'Female' #TESTING
df_panel2$Sex[df_panel2$Sex==1]<- 'Male'   #TESTING
...
g <- ggplot(df_panel2, aes(State))
g + geom_bar(aes(fill=Sex), width = 0.7) + 
...
#***mean avg replacement per state
#***** testing*****
