...
#*** Nina please add based on our discussion today, overwrite it on df_panel2 so that the next lines of code can still work"
### Also be mindful if you change columns names above we need to modify them elsewhere###
