...
At the beginning of the project and having just been able to explore the Labour Department database on Unemployment Insurance our initial question was focused on Which population segment and industries in the United States of America have seen more population dis-incentivization to return to work due to the Unemployment Insurance under the 2008 financial crisis and COVID-19 evaluating monthly information for the years 2008-2022?. However, after reviewing additional data sources that have more granular data we were able to focus on the following question:
